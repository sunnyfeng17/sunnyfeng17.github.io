const ProjectData = [
  { 
    ...
    lessons: ['Used React, Sass, Bootstrap/Reactstrap, Andt, and EmailJs for the first time!', 'I learnt how to do a Hand Drawn Effect in Illustrator (As seen on my landing page)', 'Deploying to github pages - including how to deploy a React project to github pages without losing all my work (Note to self: Don\'t git pull when you don\'t know what you\'re pulling)'],
    contributions: null,
  ...
  { 
    ...
    lessons: ['Used Next.js, Tailwind CSS for the first time!'],
  ...
  { 
    ...
    lessons: ['How to deploy using heroku', 'Express', 'EJS templates'],
  ...
  { 
    ...
    lessons: ['Figma', 'Competitor analysis', 'Business cost analysis'],
  ...
  { 
    ...
    lessons: ['Node.js', 'EJS templates', 'Express', 'Client side validation', 'How to use git collaboratively'],
